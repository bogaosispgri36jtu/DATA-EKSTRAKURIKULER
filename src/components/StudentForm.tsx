...
Tahun Pelajaran: ${registeredStudent.tahunPelajaran}`;
      ...
      ddoc.text('Orang Tua/Wali Murid', 165, signY + 7, { align: 'center' });
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100 max-w-xl w-full flex flex-col justify-center items-center p-8 md:p-10 text-center">
          ...
          <div className="space-y-3 w-full">
            <button
              ...
              id="btn-download-pdf"
              className="w-full bg-blue-700 hover:bg-blue-800 text-white text-base font-bold py-3.5 px-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
            >
      ...
      <div className="bg-gradient-to-br from-blue-800 via-blue-900 to-slate-950 text-white pt-6 pb-12 sm:pt-8 sm:pb-14 px-3.5 sm:px-6 relative overflow-hidden shadow-md border-b border-slate-800">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center justify-center text-center gap-1.5 relative z-10">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-xl sm:text-xl md:text-xl font-bold tracking-wide leading-tight">Pendaftaran Ekstrakurikuler</h1>
            <div className="text-[16px] sm:text-xl md:text-xl text-yellow-300 font-black tracking-wider mt-0.5">
              SMP PGRI JATIUWUNG
            </div>
